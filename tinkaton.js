export const Tinkaton = {
  ...
  cries: {
    latest:
      "https://raw.githubusercontent.com/PokeAPI/cries/main/cries/pokemon/latest/959.ogg",
    legacy: null,
  },
  forms: [
    { name: "tinkaton", url: "https://pokeapi.co/api/v2/pokemon-form/959/" },
  ],
  game_indices: [],
  height: 7,
  held_items: [],
  id: 959,
  is_default: true,
  location_area_encounters: "https://pokeapi.co/api/v2/pokemon/959/encounters",
  moves: [
    {
    ...
    {
      move: { name: "metal-claw", url: "https://pokeapi.co/api/v2/move/232/" },
      version_group_details: [
        {
          level_learned_at: 8,
          move_learn_method: {
    ...
    {
      move: { name: "flatter", url: "https://pokeapi.co/api/v2/move/260/" },
      version_group_details: [
        {
          level_learned_at: 43,
          move_learn_method: {
    ...
    {
      move: { name: "skill-swap", url: "https://pokeapi.co/api/v2/move/285/" },
      version_group_details: [
        {
          level_learned_at: 0,
          move_learn_method: {
    ...
    {
      move: { name: "metal-sound", url: "https://pokeapi.co/api/v2/move/319/" },
      version_group_details: [
        {
          level_learned_at: 0,
          move_learn_method: {
    ...
    {
      move: { name: "smack-down", url: "https://pokeapi.co/api/v2/move/479/" },
      version_group_details: [
        {
          level_learned_at: 0,
          move_learn_method: {
    ...
    {
      move: { name: "heavy-slam", url: "https://pokeapi.co/api/v2/move/484/" },
      version_group_details: [
        {
          level_learned_at: 0,
          move_learn_method: {
    ...
    {
      move: { name: "fairy-wind", url: "https://pokeapi.co/api/v2/move/584/" },
      version_group_details: [
        {
          level_learned_at: 1,
          move_learn_method: {
    ...
    {
      move: { name: "steel-beam", url: "https://pokeapi.co/api/v2/move/796/" },
      version_group_details: [
        {
          level_learned_at: 0,
          move_learn_method: {
    ...
    {
      move: { name: "pounce", url: "https://pokeapi.co/api/v2/move/884/" },
      version_group_details: [
        {
          level_learned_at: 0,
          move_learn_method: {
    ...
    },
    {
      move: {
        name: "gigaton-hammer",
        url: "https://pokeapi.co/api/v2/move/893/",
      },
      version_group_details: [
        {
          level_learned_at: 0,
    ...
    {
      move: { name: "hard-press", url: "https://pokeapi.co/api/v2/move/912/" },
      version_group_details: [
        {
          level_learned_at: 0,
          move_learn_method: {
